...
import img7 from "./img/project7.jpg";
...
<div className="projects__content grid filters__active" data-content id="projects">
  ...
  <article className="projects__card">
    ...
    <div className="projects__modal">
      <div>
        ...
        <a href="https://shopiyfc.netlify.app/" className="projects__button button button__small">
          <i className="ri-link" />
        </a>
      </div>
    </div>
  ...
  <article className="projects__card">
    ...
    <div className="projects__modal">
      <div>
        ...
        <h3 className="projects__title">GYM WEB only movil</h3>
        <a href="https://yf2405.github.io/-gym.github.io/" className="projects__button button button__small">
          <i className="ri-link" />
        </a>
      </div>
    </div>
  ...
  <article className="projects__card">
    <img src={img7} alt className="projects__img" />
    <div className="projects__modal">
      <div>
        <span className="projects__subtitle">Design</span>
        <h3 className="projects__title">order the numbers to win!</h3>
        <a href="https://yf2405.github.io/-gym.github.io/" className="projects__button button button__small">
          <i className="ri-link" />
        </a>
      </div>
